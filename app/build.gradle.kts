...
android {
    namespace = "com.aithink.studycompanion"
    compileSdk = 36
...
dependencies {
    // RunAnywhere SDK - Local AAR files (commented out due to compatibility issues)
    ...
    // Coroutines (Required by RunAnywhere SDK)
    ...
    // Retrofit for API calls (fallback)
